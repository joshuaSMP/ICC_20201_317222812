...
import processing.core.PImage;
/**
 * Creamos la clase ChessGui y fue extendida de PApplet
 */
...
/**
 * Metodo que nos da los settings()
 */
    @Override
 ...
 */
    ...
    public void dibujaTablero(){
        for (int i = 0; i < tablero.getSize();i++) {
            for (int j = 0; j < tablero.getSize(); j++) {
                ...
                Pieza p = tablero.getPieza(new Posicion(i, j), 0);
                drawPiece(p);
            }
        }
    }
    ...
    **/
    ...
    public void indicaTurno() {
        ...
        System.out.println("Le toca a: "+turn.toString().toLowerCase());
        System.out.println("************************************************");
    }
