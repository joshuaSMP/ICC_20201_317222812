...
/**
 * Esta es la clase donde se evaluaran los metodos de la clase Matrix e imprimrira en la
 * consola "succesfull" si el metodo es correcto de lo contrario "failed" 
 */
public class MatrixTest{
  public static void scalarProduct_test() {
        ...
        x.scalarProduct(2);
        if (x.equals(y)) {
            System.out.println("scalar product passed");
        } else {
    ...
    public static void matrixProduct_test() {
        ...
        x.matrixProduct(y);
        if (x.equals(z)) {
            System.out.println("matrixProduct passed");
        } else {
    ...
    public static void determinant_test() {
        ...
        x.determinant();
        if (x.determinant ()==6){
            System.out.println("Determinant passed");  
        }else{
